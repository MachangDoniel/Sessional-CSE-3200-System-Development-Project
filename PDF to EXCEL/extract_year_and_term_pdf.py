...
def extract_year_term_before_table(pdf_path):
    ...
    with pdfplumber.open(pdf_path) as pdf:
        ...
        for page_num in range(num_pages):
            ...
            match_bills = re.search(pattern_bills, text)
            match_exam = re.search(pattern_exam, text)
...
try:
    result_bills, result_year, result_exam = extract_year_term_before_table(pdf_path)
